...
*Note:* theta is used in radians inside the trig functions (the notebook converts degrees → radians).
...
* **t assignment:** t = np.linspace(6.0, 60.0, N).
...
**Linear Fit for M (using rotated coordinates):**
